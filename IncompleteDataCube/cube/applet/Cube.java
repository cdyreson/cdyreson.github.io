...
public class Cube extends Applet {
  ...
  private java.awt.List[] measureList; 
  ...
  // the partialButton is to find partial answers
  ...
  public void init() {
    global = new Globals();
    measureList = new java.awt.List[Constants.dimensions];
    unitList = new java.awt.List[Constants.dimensions];
    ...
    for (int i = 0; i < Constants.dimensions; i++) {
      ...
      measureList[i] = new java.awt.List(5,false);
      unitList[i] = new java.awt.List(5,false);
      ...
      for (int j = 0; j < v.size(); j++) {
        measureList[i].add(v.elementAt(j).toString());
        unitList[i].add(v.elementAt(j).toString());
        }
      }
    ...
    // Create the partial answer button
    partialButton = new Button("Partial Answers");

    // Create the reload buttons
    for (int i = 0; i < Constants.dimensions; i++) {
  ...
  **/
  ...
  /**
  * Find a partial answer using the selected items!  
  **/
  public void partialAnswers () {
    ...
    String result = Federation.getPartialAnswers(querySpec, global);
    if (result == null) {
      queryString += "\nNo partial answers found.\n";
      }
    else {
      queryString += "Try one of the following.\n" + result;
      }
  ...
  **/
  public void runQuery() {
    ...
    CubetteSpecification querySpec = new CubetteSpecification(u, m);
    String result = Federation.getQueryResult(querySpec, global);
    if (result == null) {
  ...
  **/
  public void drillDown(int dimension) {
    ...
    java.awt.List selectedUnitList = unitList[dimension];
    ...
    if (r != null) {
      ...
      sortIt(v);
      for (int j = 0; j < v.size(); j++) {
        selectedUnitList.add(v.elementAt(j).toString());
        }
      }
    }
  ...
  **/
  public void updateUnit(int dimension) {
    java.awt.List selectedUnitList = unitList[dimension];
    java.awt.List selectedMeasureList = measureList[dimension];
