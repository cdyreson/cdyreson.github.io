...
public class CubeGUI extends Frame {
  ...
  public static java.awt.List[] measureList; 
  public static java.awt.List[] unitList; 
  ...
  public void init() {
    ...
    for (int i = 0; i < Constants.dimensions; i++) {
      ...
      for (Enumeration e = global.measureTables[i].enumerateKeys(); e.hasMoreElements();) {
        ...
        System.out.println("measure is " + k.toString());
        measureList[i].add(k.toString());
        unitList[i].add(k.toString());
        }
        measureList[i].addItemListener(new ItemListener() {
          public void itemStateChanged(ItemEvent e) {
            String iname = (String) e.getItem();
            System.out.println("name is " + iname);
            }
         });
      }
    }
   ...
   * Handle an event
   **/
    public boolean gaction(Event event, Object what) {
  ...
  **/
  public void selectUnit(int dimension) {
    ...
    //selectedUnitList.add(unit.toString());
    ...
    if (measuresLoaded[dimension]) {
      ...
      for (Enumeration e = 
        ...
        if (stopMeasureSet.memberOf(tempMeasure)) {
          selectedUnitList.add((new Id(g)).toString());
          }
        }
      }
