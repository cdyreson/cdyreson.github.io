#!/net/local/bin/perl -I/net/zeus/facstaff/cdyreson/public_html/cgi-bin/perl/pm -I/net/zeus/facstaff/cdyreson/public_html/cgi-bin/perl/RadekCube/lib
...
my $ROOT = 'http://www.eecs.wsu.edu/cgi-bin/cgiwrap/~cdyreson/cgi-bin/perl/RadekCube';
...
<table summary="table" border="0" cellPadding="0" cellSpacing="0">
  <tr>
    <td bgColor="#DEFEDE" align=left valign=top>
      <table summary="table" border="0" cellSpacing="1">
        <tr>
          <td >
             <img src="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/cube.gif" 
                  alt="cube logo" 
                  width="90" 
                  height="68"
                  border="2">
      ...
      <table summary="table" border="0" cellpadding="2" cellspacing="2">
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/index.htm">
              Cube Home&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/overview.htm">
              Overview&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/publications.htm">
              Publications
             </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/javademo.htm">
              Java Demo&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/perldemo.htm">
              Perl Demo&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/IncompleteDataCube/code.htm">
              Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        ...
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/">
              Home
              </a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/publications.htm">
              Publications
            </a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/projects.htm">
              Projects
             </a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/code.htm">Software</a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/demos.htm">Demos</a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/teaching.htm">Teaching</a>
        </td></tr>
        <tr><td bgcolor="#DEFEDE">&nbsp;</td><td bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/pub/contact.htm">Contact me</a>
        </td></tr>
      </table>
    </td>
    <td>
  ...
  <a href="http://www.eecs.wsu.edu/~cdyreson/pub//IncompleteDataCube/demoinstructions.htm">Instructions on use</a>
  <P>
  $GUI
     ...
     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      ...
      <hr noshade size="1">
     <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson">Curtis E. Dyreson</a>
