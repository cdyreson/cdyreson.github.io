...
<table summary="frame" border="0" cellPadding="0" cellSpacing="0">
  <tr>
    <td bgColor="#AADDCC" align=right valign=top>
      <table summary="hard to see" border="0" cellSpacing="1">
        <tr>
          <td><a href="http://cs.usu.edu/~cdyreson/teaching/databases/151images/logo.jpg"
                 sytle="text-decoration:none"
             ><img src="http://cs.usu.edu/~cdyreson/teaching/databases/151/images/logo.jpg" 
                  alt="logo" 
                  width="90" 
                  height="68"
                  border="0"></a
    ...
    <td align=left valign=top bgColor="#AADDCC">
        <table summary="hard to see" border="0" cellSpacing="1">
          <tr>
            <td bgcolor="#AADDCC"> 
              <big>$Title</big>
  ...
  <tr>
    <td align=center valign="top" bgcolor="#AADDCC">
      <table summary="frame" cellpadding="2" border="0" cellspacing="2">
        <tr><td colspan=2 bgcolor="#FFFFFF">
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/index.htm">
            Home&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/calendar.htm">
            Calendar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/homework.htm">
            Homework&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/syllabus.htm">
            Syllabus&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/resources.htm">
            Resources&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://cs.usu.edu/~cdyreson/teaching/databases/151/people.htm">
            People&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
      </table>
  ...
  <tr>
    <td height="20" bgColor="#AADDCC">&nbsp;</td>
    <td colspan=2 bgColor="#AADDCC" align="right">
