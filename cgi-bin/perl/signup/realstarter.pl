...
'Bedirhan Urgun' => 'burgun\@eecs.wsu.edu',
'test' => 'cdyreson\@eecs.wsu.edu',
'Cheng Li' => 'cli\@eecs.wsu.edu',
'Chris Oldfield' => 'oldfield\@disorder.chem.wsu.edu',
'Hao Jin' => 'hjin\@eecs.wsu.edu',
'Harald Gjermundrod' => 'harald\@wsu.edu',
'Jin Ding' => 'jding1\@eecs.wsu.edu',
'Kshamta Jerath' => 'kjerath\@eecs.wsu.edu',
'Lihua Ran' => 'lran\@eecs.wsu.edu',
'Mahesh Sivakumar' => 'msivakum\@eecs.wsu.edu',
'Matt Whitehead' => 'mwhitehe\@wsu.edu',
'Rong Chen' => 'rchen\@eecs.wsu.edu',
'Shuangshuang Jin' => 'sjin\@eecs.wsu.edu',
'Stefan Witt' => 'stefan_witt\@wsu.edu',
'Stig Owre' => 'sowre\@hotmail.com',
'Venkata Irava' => 'virava\@eecs.wsu.edu',
#'William Bird' => 'birdw\@katewwdb.com',
'Yingxia Wang' => 'ywang\@eecs.wsu.edu',
);

 my %Directories = (
"Andy O'Fallon" => 'andy',
'Bedirhan Urgun' => 'bedirhan',
'test' => 'cdyreson',
'Cheng Li' => 'li',
'Chris Oldfield' => 'chris',
'Hao Jin' => 'haojin',
'Harald Gjermundrod' => 'harald',
'Jin Ding' => 'jinDing',
'Kshamta Jerath' => 'kshamta',
'Lihua Ran' => 'lihua',
'Mahesh Sivakumar' => 'mahesh',
'Matt Whitehead' => 'matt',
'Rong Chen' => 'rong',
'Shuangshuang Jin' => 'shuangshuang',
'Stefan Witt' => 'stefan',
'Stig Owre' => 'stig',
'Venkata Irava' => 'venkata',
#'William Bird' => 'bird',
'Yingxia Wang' => 'yingxia',
);
...
<table summary="frame" border="0" cellPadding="0" cellSpacing="0">
  <tr>
    <td bgColor="#C5C5C5" align=right valign=top>
      <table summary="hard to see" border="0" cellSpacing="1">
        <tr>
          <td><a href="http://content.wsulibs.wsu.edu/cgi-bin/pview.exe?CISOROOT=/maps&CISOPTR=379&CISORESTMP=/qbuild/buildplate11.html&CISOVIEWTMP=/qbuild/buildplate12.html&CISOCLICK=title:subjec:creato:date:type:covera"
                 style="text-decoration:none"
             ><img src="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/images/201.jpg" 
                  alt="logo" 
                  width="90" 
                  height="68"
                  border="0"></a
    ...
    <td align=left valign=top bgColor="#C5C5C5">
        <table summary="hard to see" border="0" cellSpacing="1">
          <tr>
            <td bgcolor="#C5C5C5"> 
              <big>$Title</big>
  ...
  <tr>
    <td align=center valign="top" bgcolor="#C5C5C5">
      <table summary="frame" cellpadding="2" border="0" cellspacing="2">
        <tr><td colspan=2 bgcolor="#FFFFFF">
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/index.htm">
            Home&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/lectures.htm">
            Lectures&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/homework.htm">
            Homework&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/lessons.htm">
            Lessons&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/syllabus.htm">
            Syllabus&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/resources.htm">
            Resources&nbsp;&nbsp;
            </a>
        </td></tr>
        <tr><td colspan=2 bgcolor="#FFFFFF">
            <a style="text-decoration:none" 
               href="http://www.eecs.wsu.edu/~cdyreson/teaching/database/021/people.htm">
            People&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </td></tr>
      </table>
  ...
  <tr>
    <td height="20" bgColor="#C5C5C5">&nbsp;</td>
    <td colspan=2 bgColor="#C5C5C5" align="right">
...
sub formFinal {
  ...
  system("mv $Archive/$$data{'file'} $target/$$data{'file'}")
