...
#&generateStartPatternTimes(3794);
#  $Rows = -1;
...
#    print "INSERT INTO empn(id, name, dept)  VALUES ($i, 'foobar $high', 'simba joe $low');\n"; 
    ...
    my @psa = &generateStartPatternTimes($totalStop);
    my $otherKeys = "";
    my $otherValues = "";
...
#        $t = $t . "INSERT INTO time(id, start, stop)  VALUES ($i, $start, $stop);\n"; 
    ...
    $TIMEID = $TIMEID + 1;
    print "INSERT INTO emp(id, name, dept, start, stop)  " .
          "VALUES ($EMPTID, 'foobar $high', 'simba joe $low', $totalStart, $totalStop);\n"; 

    print "INSERT INTO empt(id, name, dept, start, stop$otherKeys$patternKeys$spatternKeys)  " .
